...
for v in AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY AZURE_STORAGE_ACCOUNT AZURE_STORAGE_ACCESS_KEY BOSH_KEY_RELATIVE_PATH BOSH_HOST BOSH_USERNAME BOSH_PASSWORD S3_BOSH_MANIFEST_RELATIVE_PATH AZURE_BOSH_MANIFEST_RELATIVE_PATH
do
  mustHave $v
done
